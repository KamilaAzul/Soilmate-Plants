"""
Django settings for soilmate_plants project.
...
ROOT_URLCONF = 'soilmate_plants.urls'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'soilmate-plants'
...
DEFAULT_FROM_EMAIL = 'soilmateplants@example.com'
